...
if genre == 'Home':
    ...
    add_bg_from_local(r'https://github.com/pROGRAMMERDATASCIENCE22/N-CMAPSS--Streamlit_deployment/blob/main/EDA%20Images/12__Featured_Image_AeroShow_Bangalore.png')
